...
export let hireFreelancer = async (taskId, freelancer, data, nodeUrl) => {
    let ts = await invokeScript({
        dApp: dAppAddress,
        call: {
...
export let reportCompleteTask = async (taskId, nodeUrl) => {
    let ts = await invokeScript({
        dApp: dAppAddress,
        call: {
...
export let acceptWork = async (taskId, complete, nodeUrl) => {
    let ts = await invokeScript({
        dApp: dAppAddress,
        call: {
            function: "acceptWork",
